<x-layouts.sidebar>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800">➕ Add New VAT</h2>
    ...
    <div class="max-w-lg mx-auto mt-6 p-6 bg-white shadow-md rounded-md">
        <form action="{{ route('vat.store') }}" method="POST" novalidate>
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" min="0" max="100" id="percentage" name="percentage" value="{{ old('percentage') }}"
            ...
            <button type="submit"
                    class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition focus:outline-none focus:ring-2 focus:ring-green-400">
                Save VAT
            </button>
        </form>
    </div>
